...
#define _MOVE_LAYER 3
#define _MOUSE_LAYER 4
#define _SYSTEM_LAYER 5
// --- END OF LAYERS ---
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_WORKMAN_LAYER] = LAYOUT_ortho_5x15(
        	...
        	// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        	_____         , /* | */ KC_LGUI, KC_LALT , KC_BSPC , KC_SPC, _TMUX_A      , /* | */ _____, _____ , _____, /* | */ TT(_MOVE_LAYER), RALT_T(KC_ENT), _____  , KC_RALT , KC_RGUI  , /* | */ TG(_SYMBOLS_LAYER))      ,
        	// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
