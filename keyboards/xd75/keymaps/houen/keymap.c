...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_WORKMAN_LAYER] = LAYOUT_ortho_5x15(
        	...
        	// ------------------------------------------------------------------------------------------------------------------
        	TG(_SYMBOLS_LAYER)        , /* | */ KC_LGUI      , KC_LALT      , _____       , KC_SPC       , MO(_WORKMAN_SHIFTED_LAYER)  , /* | */ _____ , _____ , _____  , /* | */  MO(_MOVE_LAYER)  , LT(_ALT_LAYER, KC_ENT) , KC_LEFT             , KC_DOWN      , KC_UP        , /* | */ KC_RIGHT),
        	// ------------------------------------------------------------------------------------------------------------------------------
