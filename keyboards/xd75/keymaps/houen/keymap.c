...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_WORKMAN_LAYER] = LAYOUT_ortho_5x15(
        	...
        	// ------------------------------------------------------------------------------------------------------------------------
        	_____                     , /* | */ KC_Q         , KC_D         , KC_R        , KC_W         , KC_B                         , /* | */ _____ , _____ , _____  , /* | */ KC_J             , KC_F                   , KC_U                , KC_P         , KC_SCLN      , /* | */ KC_RGUI  ,
        	LCTL_T(KC_ESC)            , /* | */ KC_A         , KC_S         , KC_H        , KC_T         , KC_G                         , /* | */ _____ , _____ , _____  , /* | */ KC_Y             , KC_N                   , KC_E                , KC_O         , KC_I         , /* | */ KC_BSPC  ,
        	LSFT_T(KC_TAB)            , /* | */ KC_Z         , KC_X         , KC_M        , KC_C         , KC_V                         , /* | */ _____ , _____ , _____  , /* | */ KC_K             , KC_L                   , KC_COMM             , KC_DOT       , KC_SLSH      , /* | */ KC_QUOT  ,
        	// ------------------------------------------------------------------------------------------------------------------
	...
	[_MOVE_LAYER] = LAYOUT_ortho_5x15(
        	...
        	OSM(MOD_LSFT) , /* | */ __v__   , __v__              , __v__    , KC_ENT  , __v__         , /* | */ __v__, __v__ , __v__, /* | */ _TMUX_PREV       , _QTILE_PREV   , __v__     , __v__       , __v__       , /* | */ __v__       ,
        	// -----------------------------------------------------------------------------------------------------------------------------------------------
